...
///
/// 1) A padding can be set, defining a rectangle around the circle, and all the rectangle is
/// clickable, so that it's easier to click the button.
///
...
class CircleButton extends StatelessWidget {
  ...
  const CircleButton({
    Key? key,
    required this.icon,
    this.padding = const Pad(all: 3.0, left: 3.5),
