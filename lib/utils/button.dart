...
class AppButton extends StatefulWidget {
  ...
  static const defaultKeypressed = const Duration(milliseconds: 100);
  ...
  /// Spend the minimum duration you want the button to be visually pressed.
  final Duration? keepPressed;
...
class _AppButtonState extends State<AppButton> {
  ...
  void _endsWithTouch() {
    ...
    if (widget.keepPressed == null)
      setState(() {
        _isPressed = false;
      });
    else {
      var _count = _keepPressedCount;
      Future.delayed(widget.keepPressed!, () {
  ...
  void _onTap() {
    ...
    //
      ...
      var currentDayTime = DayTime.nowUtc();

      var ifTheTimePassed =
          (_lastTap == null) || ((currentDayTime - _lastTap!) > widget.tapThrottle!);
